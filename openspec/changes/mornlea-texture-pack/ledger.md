...
| 3 | `/root/texture_task3_embed` | pending | pending | 0 | 官方 connector 固定 source pin `7935d064fc6f993d1b5038ed5ec17a615600cf0a`；`smooth_stone` 因缺少直接等价素材、`chest` 因批准原图为 14×14，分别改为第六、七个程序化回退，禁止近似替代或像素变换。 |

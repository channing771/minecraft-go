...
新硬件基线 MUST 来自固定 scenario v6、Memory transport、2560x1440 的无窗口正式报告；该报告 MUST 通过现有完整性和绝对门禁，并 MUST 与同一硬件的一次 TCP 报告通过现有跨 transport 比较后才能接受。

...
func main() {
	...
	allowScenarioUpgrade := flag.String("allow-scenario-upgrade", "", "只允许显式的 10:11 场景迁移")
	flag.Parse()
...
func compareReportsWithScenarioUpgrade(
	...
	allowedScenarioUpgrade := baseline.ScenarioVersion == 10 && current.ScenarioVersion == 11 &&

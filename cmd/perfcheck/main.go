...
func main() {
	...
	allowScenarioUpgrade := flag.String("allow-scenario-upgrade", "", "只允许显式的 11:12 场景迁移")
	flag.Parse()
...
func compareReportsWithScenarioUpgrade(
	...
	allowedScenarioUpgrade := baseline.ScenarioVersion == 11 && current.ScenarioVersion == 12 &&
		allowScenarioUpgrade == "11:12"

...
func TestProtocolV1SmallPacketGolden(t *testing.T) {
	...
	clients := []struct {
		...
		{"hello", StateHandshake, ClientHello{ProtocolVersion: 22}, 0, "16"},
	...
	servers := []struct {
		...
		{"server hello", StateHandshake, ServerHello{ProtocolVersion: 22}, 0, "16"},
		{"handshake reject", StateHandshake, HandshakeReject{ServerProtocolVersion: 22, Code: HandshakeVersionMismatch, Message: "no"}, 1, "1601026e6f"},

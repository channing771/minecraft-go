...
func TestProtocolV1SmallPacketGolden(t *testing.T) {
	...
	clients := []struct {
		...
		{"hello", StateHandshake, ClientHello{ProtocolVersion: 16}, 0, "10"},
	...
	servers := []struct {
		...
		{"server hello", StateHandshake, ServerHello{ProtocolVersion: 16}, 0, "10"},
		{"handshake reject", StateHandshake, HandshakeReject{ServerProtocolVersion: 16, Code: HandshakeVersionMismatch, Message: "no"}, 1, "1001026e6f"},

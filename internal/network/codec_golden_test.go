...
func TestProtocolV1SmallPacketGolden(t *testing.T) {
	...
	clients := []struct {
		...
		{"hello", StateHandshake, ClientHello{ProtocolVersion: 21}, 0, "15"},
	...
	servers := []struct {
		...
		{"server hello", StateHandshake, ServerHello{ProtocolVersion: 21}, 0, "15"},
		{"handshake reject", StateHandshake, HandshakeReject{ServerProtocolVersion: 21, Code: HandshakeVersionMismatch, Message: "no"}, 1, "1501026e6f"},

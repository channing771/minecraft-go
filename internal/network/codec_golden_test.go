...
func TestProtocolV1SmallPacketGolden(t *testing.T) {
	...
	clients := []struct {
		...
		{"hello", StateHandshake, ClientHello{ProtocolVersion: 18}, 0, "12"},
	...
	servers := []struct {
		...
		{"server hello", StateHandshake, ServerHello{ProtocolVersion: 18}, 0, "12"},
		{"handshake reject", StateHandshake, HandshakeReject{ServerProtocolVersion: 18, Code: HandshakeVersionMismatch, Message: "no"}, 1, "1201026e6f"},

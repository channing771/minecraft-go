...
func TestProtocolV1SmallPacketGolden(t *testing.T) {
	...
	clients := []struct {
		...
		{"hello", StateHandshake, ClientHello{ProtocolVersion: 17}, 0, "11"},
	...
	servers := []struct {
		...
		{"server hello", StateHandshake, ServerHello{ProtocolVersion: 17}, 0, "11"},
		{"handshake reject", StateHandshake, HandshakeReject{ServerProtocolVersion: 17, Code: HandshakeVersionMismatch, Message: "no"}, 1, "1101026e6f"},

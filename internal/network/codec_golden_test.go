...
func TestProtocolV1SmallPacketGolden(t *testing.T) {
	...
	clients := []struct {
		...
		{"hello", StateHandshake, ClientHello{ProtocolVersion: 19}, 0, "13"},
	...
	servers := []struct {
		...
		{"server hello", StateHandshake, ServerHello{ProtocolVersion: 19}, 0, "13"},
		{"handshake reject", StateHandshake, HandshakeReject{ServerProtocolVersion: 19, Code: HandshakeVersionMismatch, Message: "no"}, 1, "1301026e6f"},

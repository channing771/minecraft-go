...
func TestProtocolV1SmallPacketGolden(t *testing.T) {
	...
	clients := []struct {
		...
		{"hello", StateHandshake, ClientHello{ProtocolVersion: 20}, 0, "14"},
	...
	servers := []struct {
		...
		{"server hello", StateHandshake, ServerHello{ProtocolVersion: 20}, 0, "14"},
		{"handshake reject", StateHandshake, HandshakeReject{ServerProtocolVersion: 20, Code: HandshakeVersionMismatch, Message: "no"}, 1, "1401026e6f"},

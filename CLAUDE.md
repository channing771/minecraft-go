...
This project is indexed by GitNexus as **minecraft-go** (7684 symbols, 37563 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
